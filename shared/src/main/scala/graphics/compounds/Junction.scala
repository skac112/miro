...
import com.github.skac112.miro.{GenericSegCurve, Subpaths}
import com.github.skac112.miro.graphics.GenericPath
import com.github.skac112.miro.segments.{Arc, LineSeg}
import com.github.skac112.vgutils.{Angle, Point, ori}

import scala.math._

case class Junction(baseEnd: Point,
                    baseRadius: Double,
                    baseLargeArcFlag: Boolean,
                    baseSweepFlag: Boolean,
